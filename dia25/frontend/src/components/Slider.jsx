  ...
  return (
    <>
      <button
        ...
        className="absolute right-20 top-1/2 transform -translate-y-1/2 bg-gray-800/50 text-white p-2 rounded-full"
      >
        {stopAutoplay ? "Start Autoplay" : "Stop Autoplay"}
      </button>
      <div className="relative w-full max-w-3xl mx-auto overflow-hidden rounded-xl shadow-lg">
        <div
          className="flex transition-transform duration-500 ease-in-out max-h-200"
